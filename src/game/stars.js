...
export const STAR_MORE_STARS_COST = 100;
...
export const STAR_MORE_BOARD_WIPES_COST = 100;
export const STAR_CLEAR_FIRE_SALE_COST = 100;
export const STAR_STARBOARD_MULT_COST = 100;
