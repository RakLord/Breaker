...
## V0.2.2
- Star progress bar with readiness glow and level 40 requirement.
- Added Normal ball cap upgrade in the Star Board.
- Persistence moved to Tier 1, Advanced Persistence moved to Tier 2.
- UI cleanup: grouped stats, settings moved into modal.
- Sweeper tuning and disabled-upgrade tooltips.
